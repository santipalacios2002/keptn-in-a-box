...
ISTIO_VERSION=1.9.1
CERTMANAGER_VERSION=1.2.0
# https://github.com/keptn/keptn
KEPTN_VERSION=0.8.0
# https://github.com/keptn-contrib/dynatrace-service
KEPTN_DT_SERVICE_VERSION=release-0.11.0
# https://github.com/keptn-contrib/dynatrace-sli-service
KEPTN_DT_SLI_SERVICE_VERSION=release-0.8.0
...
microk8sEnableBasic() {
  ...
  bashas 'microk8s.enable dns:192.168.3.27 8.8.8.8'
  waitForAllPods
